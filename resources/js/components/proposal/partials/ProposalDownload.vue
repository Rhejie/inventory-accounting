                        ...
                        <div class="row justify-content-center invoice_1" style="padding-top:70px">
                            <div class="col-md-9">
                                <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                    <h1 class="display-4 font-weight-boldest mb-10">PROPOSAL</h1>
                                ...
                                <div class="d-flex justify-content-between pt-6">
                                    <div class="d-flex flex-column flex-root">
                                        <span class="font-weight-bolder mb-2">PROPOSAL NO.</span>
                                        <span class="opacity-70">{{proposal.proposal_number}}</span>
                                    </div>
                                    <div class="d-flex flex-column flex-root">
                                        <span class="font-weight-bolder mb-2">ISSUE DATE</span>
                                        <span class="opacity-70">{{proposal.issue_date}}</span>
                                    </div>
                                    <div class="d-flex flex-column flex-root">
                                        <span class="font-weight-bolder mb-2">Project</span>
                                        <span class="opacity-70">{{proposal.project_id}}</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between pt-6">
                                    <div class="d-flex flex-column flex-root">
                                        <span class="font-weight-bolder mb-2">PROPOSAL TO.</span>
                                        <span class="opacity-70">{{proposal.customer.name}}
                                        <br /><span class="invoice_company_email">{{proposal.customer.email}}</span>
                                        <br/>{{proposal.customer.contact}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="font-weight-boldest" v-for="(service, index) in proposal.services" :key="index">
                        ...
                        <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0" ref="asdsd">
                            <div class="col-md-9">
                                <div class="d-flex justify-content-between">
                                    <a :href="`/proposal/generate-pdf/${id}`" target="_blank" type="button" class="buttonPrint btn btn-light-primary font-weight-bold ">Download Proposal</a>
                                    <button type="button" class="buttonPrint btn btn-primary font-weight-bold " @click="print">Print Proposal</button>
                                </div>
                            </div>
                        </div>
                        <!-- end: Invoice action-->
...
export default {
    ...
    domtoimage.toJpeg(this.$refs.content, options).then(function (dataUrl)
    {
        ...
        due() {
            ...
            let subtotal = parseFloat(due).toFixed(2) - parseFloat(this.proposal.total_credit).toFixed(2)
            subtotal -= parseFloat(this.proposal.total_paid).toFixed(2)
