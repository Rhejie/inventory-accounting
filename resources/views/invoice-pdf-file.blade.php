...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td style="text-align:left">{{$invoice->project->name}}</td>
                </tr>
            </tbody>
        </table>
        <table>
            <thead>
                <tr>
                    <th style="text-align: left;">INVOICE TO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="text-align:left">
                        <p>Name: <span>{{$invoice->customer->name}}</span></p>
                        <p>Email: <span>{{$invoice->customer->email}}</span></p>
                        <p>Contact: <span>{{$invoice->customer->contact}}</span></p>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <table class="table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 800"> {{$invoice->subtotal}} <br/> <span style="color:#da3300; font-size=10px">without tax</span></td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right">Discount</td>
                        <td style="font-weight: 800"> {{$invoice->total_discount}}</td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right">Tax</td>
                        <td style="font-weight: 800"> {{$invoice->total_tax}}</td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right">Total</td>
                        <td style="font-weight: 800"> {{$invoice->total_amount}} <br/> <span style="color:#da3300; font-size=10px">with tax</span></td>
                    </tr>
                </tbody>
            </table>
            <br/>
            <br/>
            <span style="font-size:10px; font-weight:600;">{{$invoice->date}}</span>
        </div>
    </div>
</body>
</html>
