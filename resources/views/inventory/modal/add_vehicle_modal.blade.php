    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="add_vehicle_form" method="POST" action="{{ route('vehicle.store') }}" enctype="multipart/form-data">                    
                    ...
                    <div class="row form-row">
                         ...
                         <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="plate_number" value="" required="required">
                            </div>
                        </div>
                         ...
                         <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="body_type" value="" >
                            </div>
                        </div>
