    ...
    <div class="row">
          <div class="col-md-3">
                 <div class="pic  p-3" style="background: #fff">
                    <img src="{{ url('storage/assets/vehicle/'.$vehicle->photo) }}" class="img-fluid">
                 </div>
          </div>
          <div class="col-md-12">
                 <div class="card card-custom">
                         <div class="card-header">
                             ...
                             <h3 class="card-label">Vehicle Information</h3>
                             </div>
                         ...
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-6">
                                 <p class="m-0"><span style="font-weight: bold">BRAND NAME:</span> {{ $vehicle->brand_name }}</p>
                                 <p class="m-0"><span style="font-weight: bold">PLATE NUMBER:</span> {{ $vehicle->plate_number }}</p>
                                 <p class="m-0"><span style="font-weight: bold">BODY TYPE:</span> {{ $vehicle->body_type }}</p>
                                 </div>
                                 <div class="col-md-6">
                                 <p class="m-0"><span style="font-weight: bold">DATE ACQUIRED:</span> {{ $vehicle->date_acquired }}</p>
                                 <p class="m-0"><span style="font-weight: bold">COST:</span> {{ number_format($vehicle->cost,2) }} Php</p>
                                 <p class="m-0"><span style="font-weight: bold">ASSIGNED TO:</span> {{ $vehicle->assigned_to }}</p>
                                 </div>
                             </div>
                         </div>
                 </div>
...
<script type="text/javascript">
	 ...
	 var table = $('#DocumentTable').DataTable({
        ...
        ajax: "/inventory/equipment/documents/{{ $vehicle->id }}",
        columns: [
