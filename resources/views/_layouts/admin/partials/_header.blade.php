                            ...
                            <ul class="menu-subnav">
                                <li class="menu-item" aria-haspopup="true">
                                    ...
                                    document.getElementById('logout-form').submit();" class="menu-link">
                                        ...
                                        <span href="{{ route('logout') }}" class="menu-text" onclick="event.preventDefault();
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="/" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Clothes/Briefcase.svg-->
                                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Home.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        ...
                        @include('_layouts.admin.partials._extras.dropdown.notification')
                    </form>
                </div>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        ...
                        &nbsp;
                        &nbsp; --}}
                        <a class="btn btn-link-danger font-weight-bold btn-sm" href="{{ route('logout') }}"
