    ...
    methods: {
        ...
        async storeJob() {
            try {
                ...
                const res = await this.$API.OtherJobOrder.storeJobOrder(this.ruleForm)
                this.$notify({
                    title: 'Success',
        ...
        async updateJob() {
            try {
                this.disabledButton = true;
                this.ruleForm.date_created = this.$df.formatDate(this.ruleForm.date_created, "YYYY-MM-DD")
                const res = await this.$API.OtherJobOrder.updateJobOrder(this.model.id, this.ruleForm);
                this.$notify({
                    title: 'Success',
        ...
        async getJobOrderType() {
            try {
                ...
                const res = await this.$API.OtherJobOrder.getJobOrderType();
