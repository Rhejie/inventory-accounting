...
export default {
    ...
    created() {
        ...
        this.$EventDispatcher.listen('handleCloseTruckDoc', data => {
    ...
    methods: {
        ...
        async storeEquipmentDocument() {
            ...
            try {
                ...
                const res = await this.$API.TruckVehicle.storeDocument(this.id, formData)
                this.resetForm('fileForm');
                this.$EventDispatcher.fire('ADD_NEW_TRUCk_VEHICLE_DOCUMENt', res.data);
                this.$notify({
                    title: 'Success',
        ...
        async updateDocument() {
            ...
            try {
                ...
                const res = await this.$API.TruckVehicle.updateDocument(this.model.id, formData)

                this.$EventDispatcher.fire('UPDATE_TRUCk_VEHICLE_DOCUMENT', res.data);
                this.$notify({
                    title: 'Success',
